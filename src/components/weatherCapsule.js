...
export default function WeatherCapsule() {
    return (
        <article className="flex flex-col justify-between align-center g-[16px] text-center text-white px-[8px] py-[16px] w-[60px] h-[90%] rounded-full bg-[#48319D99] border border-white/20 shadow-capsule hover:bg-[#48319D]">
